...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Staff Portal", to: "/core/sales/portal", icon: UserCircle },
      { label: "Stock Request", to: "/core/sales/prs?dept=SALES", icon: ShoppingCart },
      { label: "Stock Taking", to: "/core/sales/receiving?dept=SALES", icon: ArrowDownLeft },
      { label: "Stock Opname", to: "/core/sales/stock?dept=SALES", icon: Archive },
      { label: "Attendance", to: "/core/sales/attendance", icon: Clock },
      { label: "Log", to: "/core/sales/logs?scope=SALES", icon: History },
      { label: "Audit", to: "/core/sales/audit-log?scope=SALES", icon: ShieldCheck },
      { label: "Workflow", to: "/core/sales/workflow?scope=SALES", icon: GitBranch },
