...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Staff Portal", to: "/core/it/portal", icon: UserCircle },
      { label: "Stock Request", to: "/core/it/prs?dept=IT", icon: ShoppingCart },
      { label: "Stock Taking", to: "/core/it/receiving?dept=IT", icon: ArrowDownLeft },
      { label: "Stock Opname", to: "/core/it/stock?dept=IT", icon: Archive },
      { label: "Attendance", to: "/core/it/attendance", icon: Clock },
      { label: "Log", to: "/core/it/logs?scope=IT", icon: History },
      { label: "Audit", to: "/core/it/audit-log?scope=IT", icon: ShieldCheck },
      { label: "Workflow", to: "/core/it/workflow?scope=IT", icon: GitBranch },
