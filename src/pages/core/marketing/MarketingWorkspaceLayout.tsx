...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Staff Portal", to: "/core/marketing/portal", icon: UserCircle },
      { label: "Stock Request", to: "/core/marketing/prs?dept=MARKETING", icon: ShoppingCart },
      { label: "Stock Taking", to: "/core/marketing/receiving?dept=MARKETING", icon: ArrowDownLeft },
      { label: "Stock Opname", to: "/core/marketing/stock?dept=MARKETING", icon: Archive },
      { label: "Attendance", to: "/core/marketing/attendance", icon: Clock },
      { label: "Log", to: "/core/marketing/logs?scope=MARKETING", icon: History },
      { label: "Audit", to: "/core/marketing/audit-log?scope=MARKETING", icon: ShieldCheck },
      { label: "Workflow", to: "/core/marketing/workflow?scope=MARKETING", icon: GitBranch },
