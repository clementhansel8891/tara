...
import { History, Download, Search, Database, FileText, Calendar, HardDrive, Archive } from "lucide-react";
...
const archiveData: ArchiveRecord[] = [
  ...
  { id: "arc-008", type: "Marketing Campaign Data", module: "Marketing", period: "Q1 2026", size: "1.2 MB", status: "processing", createdAt: "2026-04-04" },
];
...
export default function DataArchives() {
  ...
  const totalSize = archiveData.reduce((acc, a) => {
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-black text-foreground">{archiveData.length}</p>
            </div>
          </CardContent>
        </Card>
        <Card className="bg-card border-border">
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-black text-foreground">{archiveData.filter(a => a.status === "available").length}</p>
            </div>
          </CardContent>
        </Card>
        <Card className="bg-card border-border">
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-black text-foreground">Apr 2026</p>
            </div>
          </CardContent>
        </Card>
      </div>
