...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Staff Portal", to: "/core/hr/portal", icon: UserCircle },
      { label: "Stock Request", to: "/core/hr/prs?dept=HR", icon: ShoppingCart },
      { label: "Stock Taking", to: "/core/hr/receiving?dept=HR", icon: ArrowDownLeft },
      { label: "Stock Opname", to: "/core/hr/stock?dept=HR", icon: Archive },
      { label: "Attendance", to: "/core/hr/attendance", icon: Clock },
      { label: "Log", to: "/core/hr/logs?scope=HR", icon: History },
      { label: "Audit", to: "/core/hr/audit-log?scope=HR", icon: ShieldCheck },
      { label: "Workflow", to: "/core/hr/workflow?scope=HR", icon: GitBranch },
