...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Staff Portal", to: "/core/procurement/portal", icon: UserCircle },
      { label: "Stock Request", to: "/core/procurement/prs?dept=PROCUREMENT", icon: ShoppingCart },
      { label: "Stock Taking", to: "/core/procurement/receiving?dept=PROCUREMENT", icon: ArrowDownLeft },
      { label: "Stock Opname", to: "/core/procurement/stock?dept=PROCUREMENT", icon: Archive },
      { label: "Attendance", to: "/core/procurement/attendance", icon: Clock },
      { label: "Log", to: "/core/procurement/logs?scope=PROCUREMENT", icon: History },
      { label: "Audit", to: "/core/procurement/audit-log?scope=PROCUREMENT", icon: ShieldCheck },
      { label: "Workflow", to: "/core/procurement/workflow?scope=PROCUREMENT", icon: GitBranch },
