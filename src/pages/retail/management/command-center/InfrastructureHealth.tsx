  ...
  return (
    <div className="bg-white/[0.03] backdrop-blur-3xl p-6 rounded-[2rem] border border-white/5 shadow-2xl hover:bg-white/[0.05] hover:-translate-y-1 transition-all duration-700 group h-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-10 relative z-10">
        ...
        <Activity className="w-6 h-6 text-muted-foreground group-hover:text-sky-400 transition-colors" />
      </div>
      ...
      <div className="flex-1 space-y-8 relative z-10">
        <div className="relative overflow-hidden p-6 rounded-2xl bg-secondary border border-white/5 shadow-3xl group/uptime">
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <div className="px-5 py-2 rounded-xl bg-success/10 border border-emerald-500/20 text-[10px] font-black uppercase tracking-widest text-success flex items-center gap-2 shadow-lg italic">
        ...
        <div className="grid grid-cols-2 gap-8 pt-4">
          <div className="group/metric p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-emerald-500/30 hover:shadow-3xl transition-all duration-500 shadow-xl relative overflow-hidden">
          ...
          <div className="group/metric p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-blue-500/30 hover:shadow-3xl transition-all duration-500 shadow-xl relative overflow-hidden">
            ...
            <Server className="absolute top-8 right-8 w-6 h-6 text-muted-foreground group-hover/metric:text-blue-400 transition-colors" />
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground mb-4 italic">
              Active Terminals
            </p>
            <div className="flex flex-col gap-2 relative z-10">
