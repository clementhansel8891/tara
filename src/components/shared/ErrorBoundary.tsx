...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        this.props.fallback || (
          <div className="flex flex-col items-center justify-center min-h-[400px] p-8 space-y-8 animate-in fade-in duration-700 bg-muted dark:bg-muted rounded-[3rem] border border-slate-200 dark:border-slate-800 shadow-2xl m-8">
            <div className="relative">
              <div className="h-24 w-24 bg-destructive rounded-[2.5rem] flex items-center justify-center animate-pulse">
                <ShieldAlert className="h-12 w-12 text-destructive" />
              </div>
              <div className="absolute -top-2 -right-2 h-8 w-8 bg-white dark:bg-muted rounded-full flex items-center justify-center shadow-lg border border-slate-100 dark:border-slate-800">
            ...
            <div className="text-center space-y-3 max-w-md">
              ...
              <div className="mt-4 p-4 rounded-2xl bg-muted dark:bg-muted border border-slate-200 dark:border-slate-800 overflow-hidden">
