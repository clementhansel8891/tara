...
- **Unified Commerce**: Every storefront or digital channel (Web, Mobile, App, Marketplace) exists _exclusively_ as a child of the Retail module.
...
The Retail UI is built using the **Zenvix Design System**, focusing on premium aesthetics and role-based device ergonomics.
