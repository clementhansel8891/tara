...
conn.on('ready', () => {
  const script = "const { PrismaClient } = require('@prisma/client'); const prisma = new PrismaClient(); async function main() { const ids = ['de5f764b-ca3a-45b1-9a0d-3559278882eb', 'dec9e45b-8333-4404-a723-3a0497a7b144', 'c2221884-ce83-4493-a35a-17d372218694']; const result = await prisma.stores.deleteMany({ where: { id: { in: ids } } }); console.log('DELETED:', result.count); } main();";
