...
export abstract class IHRRepository {
  ...
  abstract updatePerformanceCycle(tenantId: string, id: string, data: Partial<PerformanceCycle>): Promise<PerformanceCycle>;
  ...
  // Case Management
  abstract getCases(tenantId: string, status?: string): Promise<HRCase[]>;
  ...
  abstract updateCase(tenantId: string, id: string, data: Partial<HRCase>): Promise<HRCase>;

  // Contract Management
  abstract getContracts(tenantId: string, employeeId?: string): Promise<Contract[]>;
  ...
  abstract updateContract(tenantId: string, id: string, data: Partial<Contract>): Promise<Contract>;
}
